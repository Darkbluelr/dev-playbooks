...
> AI assistants should follow these term conventions when generating code and documentation.
...
1. **Consistency**: Use the same term for the same concept across code, documentation, and comments
