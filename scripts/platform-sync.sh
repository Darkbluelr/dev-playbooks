...
update_ignore_files_if_needed() {
  ...
  local -a git_entries=()
  git_entries+=("# DevBooks local runtime data (do not commit)")
  git_entries+=(".devbooks/embeddings/")
  git_entries+=(".devbooks/backup/")
  git_entries+=(".devbooks/*.log")
  git_entries+=("")
  git_entries+=("# AI tool directories (from platform_targets)")
  ...
  local -a npm_entries=()
  npm_entries+=("# DevBooks developer playbooks (not needed at runtime)")
  npm_entries+=("dev-playbooks/")
  npm_entries+=(".devbooks/")
  npm_entries+=("")
  npm_entries+=("# AI tool config directories")
  npm_entries+=(".claude/")
  npm_entries+=(".cursor/")
  npm_entries+=(".factory/")
  ...
  npm_entries+=("")
  npm_entries+=("# DevBooks instruction files")
