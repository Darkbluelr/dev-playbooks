...
Error codes should be human-readable and easy to understand.
...
// Avoid: numeric or meaningless codes
'E10001'
'ERR_X7B2'
```
...
Each error code should be unique across the system.
...
Once published, error codes should not change meaning.
...
class AppError extends Error {
  ...
  constructor(
    ...
    this.isOperational = true;  // Distinguish business vs system errors
...
2. Confirm the user was not deleted
3. Confirm sufficient access permission
...
When designing error codes, confirm:

- [ ] Codes are semantic (human-readable)
- [ ] Codes are unique (global)
- [ ] Codes include module prefix
- [ ] HTTP status codes are mapped correctly
- [ ] Error messages are user-friendly
- [ ] Sensitive information is redacted
- [ ] Codes are registered in the registry
